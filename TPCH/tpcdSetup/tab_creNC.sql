 ...
 --- TPC_D\tab_Cre.sql   GeneMi   1997/02/08 15:02
  create table part
...
create table supplier
				 (s_suppkey             int                    not null primary key nonclustered,
...
create table partsupp
				...
				constraint ps_pk primary key nonclustered (ps_partkey, ps_suppkey))
...
create table lineitem
				...
				constraint l_pk primary key nonclustered (l_orderkey, l_linenumber))

create table nation
				(n_nationkey        int          not null primary key nonclustered,
				 n_name             char(25)     not null,
				 n_regionkey        int          not null,
				 n_comment          varchar(152) not null)

create table region
				(r_regionkey        int          not null primary key nonclustered,
