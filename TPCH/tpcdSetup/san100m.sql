...
insert into #rowcounts values ('SUPPLIER',1000)
insert into #rowcounts values ('PART',20000)
insert into #rowcounts values ('PARTSUPP',80000)
insert into #rowcounts values ('CUSTOMER',15000)
insert into #rowcounts values ('ORDERS',150000)
insert into #rowcounts values ('LINEITEM',600572)
